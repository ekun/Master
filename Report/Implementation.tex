...
Contains the roles asigned to users. \\
...
\begin{tabularx}{\linewidth}{| c | X |}
    ...
    Id & Unique id generated when the question is created.\\ \hline
   	...
   	CommitTag & The tag which the question is generated from.\\ \hline
    \hline
\end{tabularx}
\vspace{0.5cm}

\section{User Interface}
Explain it and how we implemented it. Show sketches etc.....

\subsection{Responsive webdesign}
Explain the benefits with reponsive webdesign.
