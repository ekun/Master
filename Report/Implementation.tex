...
When retriving data from github we used the provided API as described by their developer-site\footnote{\url{http://developer.github.com/v3/}}, this enabled us to controll the sequence of data and when to ask for what type of data. All communication to github servers are asynchronous and whil therefor not introduce any performance related issues. 
