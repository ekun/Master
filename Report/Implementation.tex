...
The password are encrypted with SHA-512 encryption which is a part of SHA-2 a set of encryption hashing functions created by the U.S. National Security Agency.\\
...
When implementing the desing as discussed in the earlier chapter, we had a lot of focus on creating a simplet yet informativ page-layout.
