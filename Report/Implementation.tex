...
In this section we will show and discuss all data stored related to users, the tables below is representing the different data types associated with users. Users are a vital part of the implementation and everything is sentered around these users, it is therefor importat to store as much relevant data as possible. \\
