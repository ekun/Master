...
Figure \ref{plananddoworktable} shows the functionality we implemented towards the \emph{Plan and do work} stage, and how our application help user(s) plan and perform their daily work tasks. 
\begin{figure}[H]
\centering
...
Figure \ref{initiatereflectiontable} shows the functionality we implemented towards the \emph{Initiate Reflection} stage, and how our application help user(s) initiate reflection. 
\begin{figure}[H]
\centering
