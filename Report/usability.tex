...
\begin{itemize}
	\item Task 1 - Start the application. (100\% Completion rate)
	\item Task 2.1 - View notifications. (100\% Completion rate)
	\item Task 3.1 - Find the \emph{Reminder} note. (100\% Completion rate)
	\item Task 3.2 - Find and share the daily reflection note. (100\% Completion rate)
\end{itemize}
