...
The usability test was conducted on four participants, recruited from a software development project course at NTNU(IT2901)\footenote{\url{http://www.ntnu.edu/studies/courses/IT2901#tab=omEmnet}}. The application was evaluated in it's production stage, using the most-recent version at the time. User-interaction with the PeacefulBanana application was done through an Internet Browser(Google Chrome\footnote{\url{http://www.google.com/intl/no/chrome/browser/}}). The user's were recruited , and the test was ran with the latest production version of the application. \\
