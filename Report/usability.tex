...
% Describe the results by: explaining any task that had 100% completion rates. Follow this with the tasks that had the next highest completion rates. Then describe the tasks with the poor completion rates. 
\subsubsection{Task ratings}
% TODO : Dette. evt bare fjerne det avhengig av hva som trengs/ giddes
