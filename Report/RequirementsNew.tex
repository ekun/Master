...
The application is designed with a client-server architecture in mind, so the requirements here is divided to the specific parts of the architecture. In this case the client requirements are for the the websites graphical user interface and the server requirements are for the servers back end functionality.
...
These requirements are for the server graphical user interface and the functionality they need to have in order for them to do the scenarios defined in section \ref{sec:scenarios}. 
...
These requirements is designed to ensure that the application works as described in the scenarios in section \ref{sec:scenarios} and that the data is handled in a proper manner.
