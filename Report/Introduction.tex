...
In this section we will look at some of the core concepts for this thesis and what the application builds upon. The concepts are areas that needs introduction in order to gain understanding of the thesis and its theoretical background.

\subsubsection{Reflection}
The goal is to offer technology that not only makes information search and collection efficient, but also support reflection in a collaborative session. Through reflection, learning can be achieved and users can collaborate on gathering information for experiences and reflecting these in order to apply lessons learned.
