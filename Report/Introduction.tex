...
Peacefulbanana Application
\subsubsection{Chapter 3}
Background chapter
\subsubsection{Chapter 4}
Problem elaboration , scenarios
\subsubsection{Chapter 5}
State of the art, literature review, related work
...
The chapter includes a description of the final evaluation of the application, performed with a student-group in the IT2901 course at NTNU. The chapter also features a discussion of the results gathered compared to our research questions. 
