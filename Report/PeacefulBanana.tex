...
The prototype will be a tool supporting reflection. The tool will integrate with Github and the features it provides, see section \ref{githubchapter}. The tool will not provide the same possibilities already found on Github, but integrate with it using the existing data and provide an additional layer of features specific for aiding reflection in software development projects. 
