...
HuBoard is similar to the GitHub burndown application in the sense that it displays the milestones and issues to be more in a way suited for a specific agile development method, in this case it is Kanban. Which is a system for just-in-time(JIT) production. Similar to the GitHub burndown application discussed above we looked at the integration with GitHub and used that for inspiration, we also looked at it visually for inspiration since HuBoard is very well designed.
