...
\section{MIRROR CSRL Model}
This section will cover the stages in the MIRROR CSRL reflection cycle and describe how we utilize the model in context of our research questions.
\subsection{Plan and do work}
In the \emph{Plan and do work} we describe how the app helps the user(s) to:
\begin{figure}[H]
\centering
    \includegraphics[width=\textwidth]{plananddoworktable}
\caption{Mirror CSRL Cycle - Plan and do work stage}
...
\caption{Mirror CSRL Cycle - Initiate Reflection}
...
\caption{Mirror CSRL Cycle - Conduct reflection session}
