...
\\
\centering How to scaffold collection of data in order to promote reflection?
\\
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.5pt}} 
...
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.5pt}} 
\\
\centering  How to increase the tendency to reflect on experiences, both individually and as a team?
\\
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.5pt}} 
...
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.5pt}} 
\\
\centering How to bring together contributions from multiple users, possibly using different conceptualization of the work process?
\\
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.5pt}} 
...
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.5pt}} 
\\
\centering  How to promote experienced-based learning from reflection based on project artifacts collected from version-control systems
\\
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.5pt}} 
