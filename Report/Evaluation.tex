...
The next step in the process is reflection. This step uses the data collected in order for users to revisit experiences and to trigger reflection on these. Allowing the user to compare his individual tag-cloud with the team-wide tag-cloud may further help trigger this reflection. This was further agreed upon by the results from the evaluations, even though the focus group participants had some issues with the tags in the tag-cloud was not distinct enough. The users are prompted to fill out a daily reflection note and this process is more scaffolded, providing a frame for users with a set of questions related to their daily activities.
