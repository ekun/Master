...
We will create a proof of concept prototype tool for promoting experienced-based learning from reflection based on project artifacts collected from version-controll systems. From this point the prototype will be referred to as the application.

% DET HER MÅ VÆRE FEIL From this point the artifact will be referred to as the application.
